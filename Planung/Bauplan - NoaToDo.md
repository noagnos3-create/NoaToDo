...
`Code/tests/` existiert, `pytest.ini` liegt daneben, Aufruf aus `Code/`:
...
2. **Build / Packaging (Bauprozess):**
   ...
   - *(Umgesetzt 2026-08-10: `Code/requirements.lock.hashes.txt`, erzeugt von
     `Code/tools/lock_hashes.py`; Installation für den Release-Build mit
...
6. **Update-/Release-Story (V10, ergänzt 2026-07-15; Status-Modal-Teil umgesetzt 2026-08-10):**
   - **Version sichtbar:** das Status-Modal zeigt Versionsnummer und Build-Datum an
     ...
     aus `Code/buildinfo.py`, das Modal rendert daraus die drei Zeilen „Version",
